package dev.nottekk.notvolt.audio.music;
...
public class TrackScheduler extends AudioEventAdapterWrapped {
    ...
    public void nextTrack(GuildMessageChannelUnion textChannel, int position, boolean silent) {
        ...
        if (track != null) {
            // TODO:: Really stupid workaround for https://github.com/NotVolt-Applications/NotVolt/issues/299! This should be rechecked later if it even worked.
            if (!silent)
